...
public class SheetsQuickstart {
    ...
    public static Credential authorize() throws IOException {
        ...
        InputStream in = new FileInputStream("C:\\Users\\Dennis\\eclipse-workspace\\GoogleSheetTester\\src\\main\\resources\\client_secret.json");
    ...
    public static void updateSheet(String studentID, String classID, String code, String text) throws IOException {
        ...
        String spreadsheetId = "1bMV7UpRImB20B79yJfdt8IWlRw6zYrTkcxj8HXRIEY4";
        ...
        requests.add(new Request()
                .setUpdateCells(new UpdateCellsRequest()
                        .setStart(new GridCoordinate()
                                ...
                                .setColumnIndex(8)) // set the new column 6 to value 5/28/2018 at row 0
         ...
         requests.add(new Request()
                 .setUpdateCells(new UpdateCellsRequest()
                         .setStart(new GridCoordinate()
                                 ...
                                 .setColumnIndex(8)) // set the new column 6 to value "yes" at row 1
                         .setRows(Arrays.asList(
